...
export class RetailerInfoStoreService {
	// ================================================
	// =              ATTRIBUTES SECTION              =
	// ================================================
	...
	loadRetailerInfoDetailbyCode(code: any) {
		...
		return this.retailerService.getRetailerInfobyCode(code).pipe(
			map((res: any) => {
				if (res) {
					this.store.dispatch(
						new LoadRetailerInfoDetailSuccess(new RetailerInfo(res.result))
					);
	...
	find(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
		return this.retailerService.find(queryParams).pipe(
			tap((res: any) => {
