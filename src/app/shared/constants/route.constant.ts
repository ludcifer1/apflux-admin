...
export const metronicRoutes: Routes = [
					{
						...
						children: [
							...
							},
							{
								...
								loadChildren: () =>
									import(
										'app/page-modules/distributor/distributor.module'
									).then(m => m.DistributorModule)
							},
							{
								path: 'timeTable',
								loadChildren: () =>
									import('@app/page-modules/time-table/time-table.module').then(
										m => m.TimeTableModule
									)
							},
							{
								path: 'news',
								loadChildren: () =>
									import('@app/page-modules/news/news.module').then(
										m => m.NewsModule
									)
							},
