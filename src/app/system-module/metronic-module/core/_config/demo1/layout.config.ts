...
export class LayoutConfig {
					public defaults: LayoutConfigModel = {
						...
						self: {
							...
							logo: {
								light: './assets/media/logos/default_logo.png',
								dark: './assets/media/logos/default_logo.png',
								brand: './assets/media/logos/default_logo.png',
								green: './assets/media/logos/default_logo.png'
							}
						},
						...
						loader: {
							enabled: true,
							type: 'spinner-logo',
							logo: './assets/media/logos/default_logo.png',
							message: 'Please wait...'
						},
